...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        # It checks if the class BaseModel is the same type as the instance
        # of BaseModel.
    ...
    def test_id_is_public_str(self):
        # It checks if the type of the id attribute of the BaseModel class is a
        # string.
    ...
    def test_str_representation(self):
        ...
        # 3. We’re setting the id, created_at, and updated_at attributes of
        # the BaseModel object.
        # 4. We’re calling the __str__ method of the BaseModel object.
        # 5. We’re checking that the output of the __str__ method contains
    ...
    def test_instantiation_with_args_and_kwargs(self):
        ...
        # 3. We create a BaseModel object with the id “345” and the created
        # at and updated_at attributes set to the ISO 8601 string.
        # 4. We check that the id attribute is set to “345”.
        # 5. We check that the created_at attribute is set to the datetime
        # object.
        # 6. We check that the updated_at attribute is set to the datetime
        # object.
        dt = datetime.today()
        dt_iso = dt.isoformat()
